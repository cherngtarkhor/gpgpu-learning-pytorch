...
# python neural_woq_trans.py --model meta-llama/Llama-3.2-1B-Instruct --woq --woq_algo "Rtn" --benchmark --benchmark_iters 1 --num_warmup 0

# load_in_4bit require bitsandbytes
# python neural_woq_trans.py --model meta-llama/Llama-3.2-1B-Instruct --load_in_4bit True --benchmark --benchmark_iters 1 --num_warmup 0
